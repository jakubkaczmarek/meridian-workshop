      ...
      <div v-if="isOpen && backlogItem" class="modal-overlay" @click="close">
        <div class="modal-container" @click.stop>
          <div class="modal-header">
            <h3 class="modal-title">{{ t('backlog.shortageDetails') }}</h3>
          ...
          <div class="modal-body">
            <div class="shortage-header">
              ...
              <div class="shortage-title-section">
                ...
                <div class="item-sku">{{ t('inventory.table.sku') }}: {{ backlogItem.item_sku }}</div>
              </div>
              <span class="priority-badge" :class="backlogItem.priority">
                {{ t('backlog.priorityLabel', { level: t('priority.' + backlogItem.priority.toLowerCase()) }) }}
              </span>
            </div>

            <div class="shortage-summary">
              <div class="summary-card danger">
                <div class="summary-label">{{ t('backlog.shortageAmount') }}</div>
                <div class="summary-value">{{ shortage }} units</div>
              </div>
              <div class="summary-card warning">
                <div class="summary-label">{{ t('dashboard.inventoryShortages.daysDelayed') }}</div>
                <div class="summary-value">{{ backlogItem.days_delayed }} {{ t('dashboard.inventoryShortages.days') }}</div>
              </div>
            </div>

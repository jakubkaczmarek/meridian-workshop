      ...
      <div v-if="isOpen && inventoryItem" class="modal-overlay" @click="close">
        <div class="modal-container" @click.stop>
          <div class="modal-header">
            <h3 class="modal-title">{{ t('inventory.itemDetails') }}</h3>
          ...
          <div class="modal-body">
            <div class="item-header">
              ...
              <div class="item-title-section">
                ...
                <div class="item-sku">{{ t('inventory.table.sku') }}: {{ inventoryItem.sku }}</div>
              </div>
            ...
            <div class="stock-summary">
              ...
              <div class="summary-card" :class="getSummaryCardClass()">
                <div class="summary-label">{{ t('inventory.stockLevel') }}</div>
                <div class="summary-value">{{ stockPercentage }}%</div>
                <div class="summary-subtitle">{{ t('inventory.vsReorderPoint') }}</div>
              </div>
            </div>
            ...
            <div class="info-grid">
              ...
              <div class="info-item">
                <div class="info-label">{{ t('inventory.unitsRemaining') }}</div>

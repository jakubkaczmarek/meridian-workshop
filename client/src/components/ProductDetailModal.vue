      ...
      <div v-if="isOpen && product" class="modal-overlay" @click="close">
        <div class="modal-container" @click.stop>
          <div class="modal-header">
            <h3 class="modal-title">{{ t('inventory.productDetails') }}</h3>
          ...
          <div class="modal-body">
            <div class="product-header">
              ...
              <div class="product-title-section">
                ...
                <div class="product-sku">{{ t('inventory.table.sku') }}: {{ product.sku }}</div>
              </div>
            ...
            <div class="info-grid">
              ...
              <div class="info-item">
                <div class="info-label">{{ t('inventory.currentStock') }}</div>
